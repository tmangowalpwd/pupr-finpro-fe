...
const PerumahanSection = () => {
  ...
  const data1Formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.patch(API_URL + "/section/data/1", {
          title: values.title,
  ...
  const data2Formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.patch(API_URL + "/section/data/2", {
          title: values.title,
          data_number: values.data_number,
          data_unit: values.data_unit,
        });
  ...
  const data3Formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.patch(API_URL + "/section/data/3", {
          title: values.title,
          data_number: values.data_number,
          data_unit: values.data_unit,
        });
  ...
  const data4Formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.patch(API_URL + "/section/data/4", {
          title: values.title,
          data_number: values.data_number,
          data_unit: values.data_unit,
        });
...
export default PerumahanSection;
