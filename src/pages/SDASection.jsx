...
const SDASection = () => {
  ...
  const data5Formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.patch(API_URL + "/section/data/5", {
          title: values.title,
  ...
  const data6Formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.patch(API_URL + "/section/data/6", {
          title: values.title,
          data_number: values.data_number,
          data_unit: values.data_unit,
        });
  ...
  const data7Formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.patch(API_URL + "/section/data/7", {
          title: values.title,
          data_number: values.data_number,
          data_unit: values.data_unit,
        });
  ...
  const data8Formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.patch(API_URL + "/section/data/8", {
          title: values.title,
          data_number: values.data_number,
          data_unit: values.data_unit,
        });
